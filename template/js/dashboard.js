(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(252, 4, 58, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(26, 115, 232, 0.02)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
      saleGradientBg2.addColorStop(0, 'rgba(191, 191, 191, 0.19)');
      saleGradientBg2.addColorStop(1, 'rgba(0, 208, 255, 0.03)');
      var salesTopData = {
          labels: ["LUN","lun", "MAR", "mar", "MER","mer", "JEU", "jeu", "VEN", "ven", "SAM", "sam", "DIM"],
          datasets: [{
              label: 'Cette semaine',
              ...
              pointBackgroundColor: ['#fc043a)', '#fc043a', '#fc043a', '#fc043a','#fc043a)', '#fc043a', '#fc043a', '#fc043a','#fc043a)', '#fc043a', '#fc043a', '#fc043a','#fc043a)'],
            ...
            pointBackgroundColor: ['#BFBFBF)', '#BFBFBF', '#BFBFBF', '#BFBFBF','#BFBFBF)', '#BFBFBF', '#BFBFBF', '#BFBFBF','#BFBFBF)', '#BFBFBF', '#BFBFBF', '#BFBFBF','#BFBFBF)'],
              pointBorderColor: ['#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff','#fff',],
        }]
      };
